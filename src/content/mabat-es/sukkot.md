---
# Traducción del número de Shabat de Sucot 5787. Misma fecha y hora exactas que el gemelo hebreo.
# Reglas: docs/SPANISH-EDITORIAL-GUIDELINES.md — tú neutro, sin coma en el salto de línea,
# citas en « », punto fuera del ». "Sejaj" se evita: "la paja sirve para el techo de una sucá".
# La frase del cuadro de cita aparece palabra por palabra en el texto (regla del pull-quote).
# parasha: "Shabat de Sucot" — empieza con "Shabat", así kickerEs no le antepone "Parashá".
...
Rezaba. Cuidaba las festividades. Todo lo que se podía.

Y había una mitzvá que nunca había logrado cumplir allí:
...
Quien se acerca a la cerca es sospechoso de intento de fuga.

**Y a quien escapa, le disparan.**

Lo sabía. Los guardias lo sabían.

Y el montón seguía ahí.

***

En la lectura de la festividad, la Torá explica por qué nos sentamos en la sucá:
...
Todavía en el desierto. Sin casa y sin saber cuánto faltaba.

Y de todo ese viaje
la Torá convirtió en fiesta
justamente las cabañas del camino.

Y sobre esa misma fiesta, en el mismo capítulo, está escrito:

«Y se alegrarán delante de Hashem, su Dios, siete días».

***

Al caer la tarde,
justo antes de que se encendieran los reflectores de las torres de vigilancia,
...
Yosef Mendelevich. Prisionero de Sion.
